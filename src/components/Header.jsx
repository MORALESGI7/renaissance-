...
const Header = () => {
  return (
    <div className='min-h-screen mb-4-cover bg-center flex items-center w-full overflow-hidden' style={{ backgroundImage: "url('src/assets/header_img.png')" }} id='Header'>
      <Navbar/>
      <motion.div
